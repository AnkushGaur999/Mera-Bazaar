...
class $AssetsFilesGen {
  ...
  /// File path: assets/files/categories.json
  String get categories => 'assets/files/categories.json';

  /// File path: assets/files/products.json
  String get products => 'assets/files/products.json';

  /// Directory path: assets/files
  String get path => 'assets/files';
