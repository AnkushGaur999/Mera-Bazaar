...
//
// import 'product_feature.mocks.dart'; // Import ProductRepository
//
...
//
//     test(
//       'should return all products when categoryId is "YsXVA7X1EgWrpUWvpf8f"',
//       () async {
//         // Arrange
//         final mockDocs = [
...
//         mockCollectionReference.where(
//           "category_id",
//           isEqualTo: nonExistentCategoryId,
//         ),
//       ).called(1);
//       verify(mockQuery.get()).called(1);
//     });
...
//       verify(mockFirebaseFirestore.collection("products")).called(1);
//       verify(
//         mockCollectionReference.where("category_id", isEqualTo: categoryId),
//       ).called(1);
//       verify(mockQuery.get()).called(1);
//     });
//   });
...
//
//     test(
//       'should return DataSuccess with list of ProductEntity on success',
//       () async {
//         // Arrange
//         when(
//           mockProductRepository.getProducts(categoryId: testCategoryId),
//         ).thenAnswer((_) async => DataSuccess(data: productEntities));
//
//         // Act
...
//       ).thenAnswer(
//         (_) async =>
//             DataError(exception: MyBazaarException.fromException(error)),
//       );
//
//       // Act
...
//
//       // Assert
//       expect(result, isA<DataError<List<ProductEntity>>>());
...
//
//     test(
//       'should return DataFailed with FirebaseException on Firestore error',
//       () async {
//         // Arrange
//         final FirebaseException firebaseError = FirebaseException(
//           plugin: 'Firestore',
//           message: 'Permission Denied',
//         );
//         when(
...
//         ).thenAnswer(
//           (_) async => DataError(
//             exception: MyBazaarException.fromException(firebaseError),
//           ),
//         );
//
//         // Act
...
//         // Assert
//         expect(result, isA<DataError<List<ProductEntity>>>());
//         expect(result.exception, isA<FirebaseException>());
//         expect(
//           (result.exception as FirebaseException).message,
//           'Permission Denied',
//         );
//         verify(
//           mockProductRepository.getProducts(categoryId: testCategoryId),
